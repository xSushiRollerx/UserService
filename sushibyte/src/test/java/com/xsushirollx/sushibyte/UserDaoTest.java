...
class UserDaoTest {
	...
	void createUserTest() {
		...
		assertThrows(DataIntegrityViolationException.class,()-> u1.save(new User("first", "last", "phone", "test2", "test2","password")));
		assertThrows(DataIntegrityViolationException.class,()-> u1.save(new User("first", "last", "phone2", "test1", "test2","password")));
		assertThrows(DataIntegrityViolationException.class,()-> u1.save(new User("first", "last", "phone2", "test2", "test1","password")));
