...
class AuthorizationControllerTest {
	...
	void logInTest() throws Exception {
		...
		mockMvc.perform(get("/login").session(session).accept(MediaType.APPLICATION_JSON))
	...
	void LogOutTest() throws Exception {
		...
		mockMvc.perform(get("/logout").session(session).accept(MediaType.APPLICATION_JSON))
